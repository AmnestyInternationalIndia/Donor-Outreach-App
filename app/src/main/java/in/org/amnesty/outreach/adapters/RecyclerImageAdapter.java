...
public class RecyclerImageAdapter extends CursorRecyclerViewAdapter<RecyclerImageAdapter.ViewHolder> {

    private Context mContext;

    public RecyclerImageAdapter(Context context, Cursor cursor) {
        super(cursor);
        mContext = context;
    }
    ...
    public RecyclerImageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
        ...
        return new ViewHolder(view, new ViewHolder.OnButtonClickListener() {
            ...
            public void onPlay(int position) {
                ...
                arguments.putInt(BaseTabFragment.BUNDLE_CURRENT_TYPE, BaseTabFragment.TYPE_IMAGE);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, Cursor cursor) {
        ...
        Bitmap mThumbnailBitmap = MediaStore.Images.Thumbnails.getThumbnail(mContext.getContentResolver(), imageId,
